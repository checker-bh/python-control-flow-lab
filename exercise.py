...
def determine_season():
    ...
    if (month_number == 12 and day >= 21) or (month_number == 1) or (month_number == 2) or (month_number == 3 and day <= 19):
        season = "Winter"
    elif (month_number == 3 and day >= 20) or (month_number == 4) or (month_number == 5) or (month_number == 6 and day <= 20):
        season = "Spring"
    elif (month_number == 6 and day >= 21) or (month_number == 7) or (month_number == 8) or (month_number == 9 and day <= 21):
        season = "Summer"
    elif (month_number == 9 and day >= 22) or (month_number == 10) or (month_number == 11) or (month_number == 12 and day <= 20):
        season = "Fall"
    else:
        season = "Unknown"
